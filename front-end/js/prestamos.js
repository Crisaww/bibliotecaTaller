...
let url="http://10.192.66.56:8000/libreria/api/v1/prestamo/";
...
function obtenerTituloLibro(id, celdaLibro) {
    ...
    $.ajax({
        url: 'http://10.192.66.56:8000/libreria/api/v1/libro'+ '/' + id + '/',  // Ajusta la URL según tu configuración
...
function cargarLibro() {
    let urlLibro = "http://10.192.66.56:8000/libreria/api/v1/libro/";
